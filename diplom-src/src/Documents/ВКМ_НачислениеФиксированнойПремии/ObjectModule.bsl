//НачалоДоработки. Барышникова Ю.А ,14.11.2024 
//Начисление премии
...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Процедура СформироватьДвиженияДопНачисления()
		...
		Для Каждого Строка Из ВКМ_СписокСотрудников Цикл  
			...
			Движение.ВКМ_Начислено = Строка.ВКМ_СуммаПремии;    
			...
			ДвижениеВз.ВКМ_Сотрудник = Строка.ВКМ_Сотрудник;
			ДвижениеВз.ВКМ_Сумма = Строка.ВКМ_СуммаПремии;   
...
Процедура РассчитатьНФДЛ()
		...
		|	ЕСТЬNULL(ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.ВКМ_НачисленоБаза, 0) КАК НачисленоБаза,
		...
		|			Регистратор = &Ссылка
		|		И ВидРасчета = &ВКМ_Удержания) КАК ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления
		...
		Запрос.УстановитьПараметр("ВКМ_Удержания",  ПланыВидовРасчета.ВКМ_Удержания.ВКМ_НДФЛ);  
