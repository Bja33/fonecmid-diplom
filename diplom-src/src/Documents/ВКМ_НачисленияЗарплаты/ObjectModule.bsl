...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Процедура СформироватьДвиженияОснНачисления()  
		...
		Для Каждого Строка Из ВКМ_Начисления  Цикл  
			...
			Движение.ГрафикРаботы = Строка.ВКМ_ГрафикРаботы;   
			...
			Если Строка.ВКМ_ВидРасчета = ПланыВидовРасчета.ВКМ_ОсновныеНачисления.ВКМ_Отпуск Тогда     
				...
				Движение.Сотрудник = Строка.ВКМ_Сотрудник;
				Движение.ОтпускФакт = (Строка.ВКМ_ДатаОкончания-Строка.ВКМ_ДатаНачала+86400)/86400;
	...
	Процедура РассчитатьОкладИВыполненныеРаботы()    
		...
		Пока Выборка.Следующий() Цикл
			...
			ДвижениеВз.Сотрудник = Движение.ВКМ_Сотрудник;
